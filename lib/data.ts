...
export const projectsData = [
  {
    title: "SocioMedia",
    description:
      "This project is built using the MERN stack, featuring user authentication, post creation and an interactive UI for social interactions. Users can like, comment and update profiles for a seamless social media experience.",
